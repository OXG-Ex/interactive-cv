...
const ProjectItem: React.FC<TProjectItemProps> = ({ item }) => {
    ...
    return <Grid container spacing={3}>
        ...
        <Grid item sm={12} md={6} >
            <Stack gap={2}>
                {area && <Typography variant="h5" color='primary.main' fontWeight={600}>{getProjectAreaTitle(area)}</Typography>}
                ...
                <Button variant="outlined" color='primary' endIcon={<GitHub />} href={link} target="_blank">
                    GitHub
                </Button>
            </Stack>
